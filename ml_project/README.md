...
Repo for homework1 in ml in prod
...
Usage:
~~~
python src/train_pipeline.py configs/train_config.yaml          -- train
python src/predict_pipeline.py configs/predict_config.yaml      -- test
~~~
